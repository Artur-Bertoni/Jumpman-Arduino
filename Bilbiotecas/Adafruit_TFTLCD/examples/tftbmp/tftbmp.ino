...
#define SD_CS 10     // 53 - Set the chip select line to whatever you use (10 doesnt conflict with the library)

// In the SD card, place 24 bit color BMP files (be sure they are 24-bit!)
// There are examples in the sketch folder

// our TFT wiring
Adafruit_TFTLCD tft(LCD_CS, LCD_CD, LCD_WR, LCD_RD, LCD_RESET );   // A4);
...
void setup()
{
 ...
 uint16_t identifier = 0x7575; //0x9488 ;
 ...
 tft.fillScreen(0); // заливка экрана чёрным
