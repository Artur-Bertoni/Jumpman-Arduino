...
void setup(void) {
...
#ifdef USE_ADAFRUIT_SHIELD_PINOUT
  Serial.println(F("Using Adafruit TFT Arduino Shield Pinout"));
#else
  Serial.println(F("Using Adafruit TFT Breakout Board Pinout"));
#endif
  ...
  identifier = 0xD3D3; // TFT 3.95 in MEGA 
  //0x7575; // TFT 2.4 in Uno/MEGA  Breakout Board Pinout
  ...
  Serial.println(F("Jackson Benchmark                Time (microseconds)"));
