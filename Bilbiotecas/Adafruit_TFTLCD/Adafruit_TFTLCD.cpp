...
// TFT LCD 2.4 UNO usar o ID=7575
//#define TFTWIDTH   240
//#define TFTHEIGHT  320

// TFT LCD 3.95 MEGA usar o ID=9488
#define TFTWIDTH   320
...
void Adafruit_TFTLCD::flood(uint16_t color, uint32_t len) {
  ...
  CS_ACTIVE;
  CD_COMMAND;
  if ((driver == ID_9341) || (driver == ID_ILI9327) || (driver == ID_ILI9488)) {
    write8(0x2C);
...
void Adafruit_TFTLCD::fillScreen(uint16_t color) {
  ...
  } else if ((driver == ID_9341) || (driver == ID_7575) || (driver == ID_HX8357D) || (driver == ID_S6D0154) || (driver == ID_ILI9327) || (driver == ID_ILI9488)) {
...
void Adafruit_TFTLCD::pushColors(uint16_t *data, uint8_t len, boolean first) {
  ...
  if(first == true) { // Issue GRAM write command only on first call
    ...
    if ((driver == ID_9341) || (driver == ID_HX8357D) || (driver == ID_ILI9327) || (driver == ID_ILI9488)){
       write8(0x2C);
     } else if (driver == ID_S6D0154){
       write8(0x22);
	 } else {
...
void Adafruit_TFTLCD::setRotation(uint8_t x) {
 ...
 if ((driver == ID_9341) || (driver == ID_ILI9488) ) { 
...
uint16_t Adafruit_TFTLCD::readID(void) {
  ...
  */
Serial.println(readReg(0x04));
Serial.println(readReg(0x04));
Serial.println(readReg(0xD3));
Serial.println(readReg(0xD3));
Serial.println(readReg(0xEF));
Serial.println(readReg(0xEF));
Serial.println(readReg(0xD0));
Serial.println(readReg(0xD0));
